...
const team = [
  { name: "José", role: "Infraestructura" },
  { name: "Andrés", role: "Automatización CI/CD" },
  { name: "Isaac", role: "QA" },
  { name: "Jeferson", role: "Validación" },
];
...
export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Acerca del proyecto</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Información general del sistema Task Manager
        </p>
      </div>
      ...
      <div className="card p-6 mb-6">
        <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Objetivo</h3>
      ...
      {/* Features */}
      <div className="card p-6 mb-6">
        <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Funcionalidades principales</h3>
      ...
      {/* Tech Stack */}
      <div className="card p-6 mb-6">
        <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-4">Tecnologías utilizadas</h3>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <div key={i} className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-900/50">
      ...
      {/* Architecture */}
      <div className="card p-6 mb-6">
        <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-4">Arquitectura</h3>
        <div className="flex flex-wrap items-center gap-2 justify-center p-6 bg-gray-50 dark:bg-gray-900/50 rounded-xl">
          {["React", "API Hono", "Drizzle ORM", "Turso"].map((item, i) => (
            <div key={i} className="flex items-center gap-2">
              <span className="px-4 py-2 rounded-lg bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400 font-medium text-sm">
                {item}
              </span>
      ...
      {/* Database */}
      <div className="card p-6 mb-6">
        <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Base de datos Turso</h3>
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
      ...
      <div className="card p-6">
        <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-4">Equipo de trabajo</h3>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {team.map((member) => (
            <div key={member.name} className="p-4 rounded-lg bg-gray-50 dark:bg-gray-900/50 text-center">
